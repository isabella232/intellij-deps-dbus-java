...
\def\javadocroot/{https://dbus.freedesktop.org/doc/dbus-java/api/}
...
specification\footnote{https://dbus.freedesktop.org/doc/dbus-specification.html}
and the API documentation\footnote{https://dbus.freedesktop.org/doc/api/html/}.
...
and hexdump libraries from \url{https://www.matthew.ath.cx/projects/java/}.
...
data is in XML
format\footnote{https://dbus.freedesktop.org/doc/dbus-specification.html\#introspection-format}.
...
bluemon\footnote{https://www.matthew.ath.cx/projects/bluemon} daemon,
